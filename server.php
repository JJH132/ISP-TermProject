...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($phone_number)) { array_push($errors, "A phone number is required."); }
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO users (email, password, phone_number, address, full_name) 
  			  VALUES('$email', '$password', '$phone_number', '$address', '$full_name')";
